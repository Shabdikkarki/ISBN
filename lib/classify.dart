...
class MnistClassifier {
  // Model files
  static final String modelFilename = "assets/mnist.tflite";
  static final String modelLabels = "assets/labels.txt";
...
Future<MnistClassifierResult> classifyImage(String imgFile) async {
  ...
  //, {MnistClassifier.imgWidth, MnistClassifier.imgHeight}
